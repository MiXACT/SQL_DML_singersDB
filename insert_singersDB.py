...
def tabs_collab(tab, ids):
    for key in ids:
        connection.execute(f"""
            INSERT INTO {tab} VALUES({int(list(ids)[key-1])}, {int(ids[key])});
        """)
    return
...
if __name__ == '__main__':
    ...
    ALBUMS = {'Chill out': 2018, 'Son': 2020, 'Take another shot': 1997, 'Drain you': 1988,
              'Call me': 1975, 'Tutti Frutti': 1963, 'Relaxing': 2018}

    TRACKS = {'Single Love': [2.5, 5], 'Yellow Jacket': [3.8, 1], 'After Dark': [5, 3], 'Insideout': [10.5, 4],
              'Top Side': [1.3, 7], 'High Way': [6.9, 6], 'Poison my sadness': [8, 2], 'True Hero': [7.1, 2],
              'Forgiveness': [4, 6], 'In 1990': [3, 3], 'Yourmyus': [9, 7], 'In God We Trust': [13, 3],
              'Venture': [5.5, 5], '1st': [3.6, 1], '40 oz': [3.5, 4]}
    ...
    TRACK_COL = {1: 4, 2: 8, 3: 3, 4: 6, 5: 2, 6: 7, 7: 1, 8: 5, 9: 1, 10: 2, 11: 3, 12: 8, 13: 4, 14: 7, 15: 5}
